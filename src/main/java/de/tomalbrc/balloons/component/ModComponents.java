...
public class ModComponents {
    ...
    public static void register() {
        Registry.register(BuiltInRegistries.DATA_COMPONENT_TYPE, ResourceLocation.fromNamespaceAndPath(Balloons.MODID, "token"), TOKEN);
        PolymerComponent.registerDataComponent(TOKEN);

        Registry.register(BuiltInRegistries.DATA_COMPONENT_TYPE, ResourceLocation.fromNamespaceAndPath(Balloons.MODID, "balloon"), ModComponents.BALLOON);
